    ...
    var fail = function(id, schema, obj, params)
    {
        ...
        switch(id)
        {
            ...
            case 'errMatchedNotValue':
                return returnFalse(typeof(obj) + " matches one of the NotValues ["+(schema.Name?schema.Name+": ":"")+"'"+JSON.stringify(obj,undefined,2)+"']");
            ...
            case 'errSigned':
             ...
             case 'errInteger':
                return returnFalse("Number is not an Integer ["+(schema.Name?schema.Name+": ":"")+"'"+JSON.stringify(obj)+"']");
